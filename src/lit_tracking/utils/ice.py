from icevision import tfms, show_samples, models
...
if __name__ == "__main__":
 parser = COCOBBoxParser(annotations_filepath="/Users/lucaactisgrosso/PycharmProjects/lit-tracking/tests/data/coco/train/labels.json",
                         img_dir="/Users/lucaactisgrosso/PycharmProjects/lit-tracking/tests/data/coco/train/data")
